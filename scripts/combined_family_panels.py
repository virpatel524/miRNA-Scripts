...
def genfig2():
	...
	sns.boxplot(x='Age (MY)', y='Jaccard Similarity Coefficient', hue='miRNA Class', data=pd_strat_expnum, showfliers=False, ax=ax2)
	sns.boxplot(x='Age (MY)', y='Jaccard Similarity Coefficient', hue='miRNA Class', data=pd_strat_tarnum, showfliers=False, ax=ax1)
	sns.boxplot(x='Age (MY)', y='Jaccard Similarity Coefficient', hue='miRNA Class', data=pd_strat_disnum, showfliers=False, ax=ax3)
