...
sns.boxplot(x='Age (MY)', y='Number of Tisuses', data=dispd,showfliers=False)
sns.stripplot(x='Age (MY)', y='Jaccard Similarity Coefficent', data=dispd, jitter=True, color='k', alpha=0.5)sns.plt.gca().set_ylim([0, 20])
sns.plt.show()
sns.plt.close()